...
# Load any previously persisted names into memory
if(EXISTS "${_HS_INSPECTOR_REGISTRY_FILE}")
    file(STRINGS "${_HS_INSPECTOR_REGISTRY_FILE}" _HS_OBJ_REGISTRY)
else()
...
function(globalObjSync varName)
    ...
    # globalObjSet above already registers
endfunction()
...
function(globalDumpAll)
    ...
    message(STATUS "")
    message(STATUS "╔══════════════════════════════════════════════════════════════════╗")
    message(STATUS "║  HS_OBJ GLOBAL STORE DUMP  (${_total} registered names)")
    if(ARG_FILTER)
    message(STATUS "║  Filter: \"${ARG_FILTER}\"")
    endif()
    message(STATUS "╚══════════════════════════════════════════════════════════════════╝")
    message(STATUS "")
