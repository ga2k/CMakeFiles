    ...
    if (TARGET ${_wx_main_target})
        ...
        if(_raw_includes)
            foreach(_path IN LISTS _raw_includes)
                if (_path MATCHES "[$]<BUILD_INTERFACE:([^>]+)>")
                    list(APPEND local_includes "${CMAKE_MATCH_1}")
                endif()
            endforeach()
        else ()
            message(STATUS "wxWidgets: No INTERFACE_INCLUDE_DIRECTORIES for ${_wx_main_target} yet.")
        endif ()
    endif ()
