...
function(wxWidgets_export_variables pkgname)
    ...
    if (EXISTS ${WX_OVERRIDE_PATH})
        ...
        foreach(lib ${components})
            set(_dirSet OFF)
            if (TARGET "wx::${lib}")
                get_target_property(_aliasTarget "wx::${lib}" ALIASED_TARGET)
                if ("${_aliasTarget}" STREQUAL "_aliasTarget-NOTFOUND")
            ...
            if (NOT _dirSet)
                message(FATAL_ERROR "Unknown library type '${_aliasTarget}' for wxWidget library '${lib}'")
            endif()
        endforeach()
