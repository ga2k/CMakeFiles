...
#    # Link Core
    ...
    if (arg_USES_WIDGETS AND WIDGETS IN_LIST APP_FEATURES)
        if (NOT ${arg_NAME} STREQUAL "wxLib" AND TARGET HoffSoft::wxLib)
            ...
            target_compile_options(${arg_NAME}      PUBLIC ${HS_wxCompilerOptions})
            target_include_directories(${arg_NAME}  PUBLIC ${HS_wxIncludePaths})
            target_link_directories(${arg_NAME}     PUBLIC ${HS_wxLibraryPaths})
            target_link_libraries(${arg_NAME}       PUBLIC ${HS_wxLibraries} ${HS_wxFrameworks})
            target_link_options(${arg_NAME}         PUBLIC ${HS_wxLinkOptions})
        endif ()
    endif ()
    # @formatter:on
