...
#        endforeach ()
    ...
    if (${pkgIndex} EQUAL -1)
        ...
        msg("Adding feature${padding}${BOLD}${APD_FEATURE}${NC} with package ${BOLD}${APD_PKGNAME}${NC}")
    else ()
        ...
        set(${activeArray} "${${activeArray}}" PARENT_SCOPE)
        msg("${YELLOW}Extend${NC} feature${padding}${BOLD}${APD_FEATURE}${NC} with package ${BOLD}${APD_PKGNAME}${NC}")
    endif ()
...
#           Keyword         Type        Direction   Description
    ...
    if(A_SET OR A_FEATURE)
        if(A_FEATURE)
            SplitAt("${inputListName}" A_PP_FEATURE dc)
        endif ()
...
function(resolveDependencies inputList allData outputList)
    ...
    foreach(item IN LISTS inputList)
        ...
        pipelist(GET "_pkg" ${PkgKindIX} _kind)
