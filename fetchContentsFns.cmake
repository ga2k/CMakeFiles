...
function(preProcessFeatures featureList hDataSource outVar)
    ...
    foreach (feature IN LISTS featureList)
        ...
        if (wantDefault)
            ...
            SELECT(FeatureName AS AA_FEATURE PackageName AS AA_PACKAGE IsDefault FROM ${hDataSource} WHERE "FeatureName" = "${AA_FEATURE}" AND "PackageName" = "${AA_PACKAGE}")
        endif ()
