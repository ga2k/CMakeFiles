...
#        set(APD_PREREQS "-")
    ...
    longest(CURRENT ${__longest_feature} GAP RIGHT MIN_LENGTH 3 PAD_CHAR " " LONGEST __longest_feature TEXT "${APD_FEATURE}" PADDED padded_feature)
    longest(CURRENT ${__longest_feature} GAP RIGHT MIN_LENGTH 3 PAD_CHAR " " LONGEST __longest_feature TEXT "${APD_PKGNAME}" PADDED padded_package)
    longest(CURRENT ${__longest_feature} GAP RIGHT MIN_LENGTH 3 PAD_CHAR " " LONGEST __longest_feature TEXT "${APD_FEATURE}" PADDED padded_feature)
    ...
    set(libraryfeatureText "       Feature ${BOLD}${padded_feature}${NC} created and added to the library feature collection")
    set(generalfeatureText "       Feature ${BOLD}${padded_feature}${NC} created and added to the general feature collection")

    set(globalpackageText  "       Package ${BOLD}${padded_package}${NC} {} feature ${BOLD}${padded_feature}${NC}")
    set(systempackageText  "       Package ${BOLD}${padded_package}${NC} {} feature ${BOLD}${padded_feature}${NC}")
    set(librarypackageText "       Package ${BOLD}${padded_package}${NC} {} feature ${BOLD}${padded_feature}${NC}")
    set(generalpackageText "       Package ${BOLD}${padded_package}${NC} {} feature ${BOLD}${padded_feature}${NC}")

    set(globalnameText     "       Feature ${BOLD}${padded_feature}${NC} {} feature names")
    set(systemnameText     "       Feature ${BOLD}${padded_feature}${NC} {} feature names")
    set(librarynameText    "       Feature ${BOLD}${padded_feature}${NC} {} feature names")
    set(generalnameText    "       Feature ${BOLD}${padded_feature}${NC} {} feature names")
