...
#            string(STRIP "${${current_tag}}" ${current_tag})
            ...
            if (current_tag STREQUAL "VERB")
                ...
                if (word1 MATCHES "created")
                    set(${current_tag} "${leading_ws}${BOLD}${YELLOW}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "added")
                    set(${current_tag} "${leading_ws}${BOLD}${WHITE}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "replaced")
                    set(${current_tag} "${leading_ws}${BOLD}${RED}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "extended")
                    set(${current_tag} "${leading_ws}${BOLD}${CYAN}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "skipped")
                    set(${current_tag} "${leading_ws}${BOLD}${BLUE}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "calling")
                    set(${current_tag} "${leading_ws}${BOLD}${GREEN}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                endif ()
...
#                _doLine(OBJECT)
            ...
            elseif (current_tag STREQUAL "SUBJECT_PREP")
                ...
                if (word1 MATCHES "for")
                    set(${current_tag} "${leading_ws}${BOLD}${YELLOW}${word1}${NC}${inter_ws}${MAGENTA}${word2}${NC}${trailing_ws}")
                elseif (word1 MATCHES "with")
                    set(${current_tag} "${leading_ws}${BOLD}${WHITE}${word1}${NC}${inter_ws}${MAGENTA}${word2}${NC}${trailing_ws}")
                elseif (word1 MATCHES "to")
                    set(${current_tag} "${leading_ws}${BOLD}${RED}${word1}${NC}${inter_ws}${MAGENTA}${word2}${NC}${trailing_ws}")
                elseif (word1 MATCHES "as")
                    set(${current_tag} "${leading_ws}${BOLD}${CYAN}${word1}${NC}${inter_ws}${MAGENTA}${word2}${NC}${trailing_ws}")
                endif ()
