...
#        set(APD_PREREQS "-")
    ...
    if(APD_KIND MATCHES "SYSTEM")
        ...
        createOrAppendCollectionObject(OBJECT "SYSTEM_FEATURES" FEATURE "${APD_FEATURE}" DATA "${output}"     EXTEND QUIET)
...
#        createOrAppendFeaturePkgList(SYSTEM_FEATURES ${APD_FEATURE} ${APD_PKGNAME} "${output}" "${displayed}")
    elseif(APD_KIND MATCHES "LIBRARY")
        ...
        createOrAppendCollectionObject(OBJECT "LIBRARY_FEATURES" FEATURE "${APD_FEATURE}" DATA "${output}"     EXTEND QUIET)
