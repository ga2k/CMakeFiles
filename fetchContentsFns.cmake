...
#        set(APD_PREREQS "-")
    ...
    set(globalfeatureText  "       Feature ${BOLD}${right_padded_feature}${NC} created and added to the global feature collection")
    set(systemfeatureText  "       Feature ${BOLD}${right_padded_feature}${NC} created and added to the system feature collection")
    set(libraryfeatureText "       Feature ${BOLD}${right_padded_feature}${NC} created and added to the library feature collection")
    set(generalfeatureText "       Feature ${BOLD}${right_padded_feature}${NC} created and added to the general feature collection")

    set(globalpackageText  "       Package ${BOLD}${right_padded_package}${NC} {} feature ${BOLD}${left_padded_feature}${NC}")
    set(systempackageText  "       Package ${BOLD}${right_padded_package}${NC} {} feature ${BOLD}${left_padded_feature}${NC}")
    set(librarypackageText "       Package ${BOLD}${right_padded_package}${NC} {} feature ${BOLD}${left_padded_feature}${NC}")
    set(generalpackageText "       Package ${BOLD}${right_padded_package}${NC} {} feature ${BOLD}${left_padded_feature}${NC}")

    set(globalnameText     "       Feature ${BOLD}${right_padded_feature}${NC} {} feature names")
    set(systemnameText     "       Feature ${BOLD}${right_padded_feature}${NC} {} feature names")
    set(librarynameText    "       Feature ${BOLD}${right_padded_feature}${NC} {} feature names")
    set(generalnameText    "       Feature ${BOLD}${right_padded_feature}${NC} {} feature names")
    ...
    createOrAppendField (   OBJECT "FEATURES"           FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} EXTEND        MARKER "{}" TEXT "${globalpackageText}")
    ...
    if(APD_KIND MATCHES "SYSTEM")
        ...
        createOrAppendField (OBJECT "SYSTEM_FEATURES"   FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} QUIET EXTEND        MARKER "{}" TEXT "${systempackageText}")
    ...
    elseif(APD_KIND MATCHES "LIBRARY")
        ...
        createOrAppendField (OBJECT "LIBRARY_FEATURES"  FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} QUIET EXTEND        MARKER "{}" TEXT "${librarypackageText}")
    ...
    elseif(APD_KIND MATCHES "USER")
        createOrAppendRecord(OBJECT "USER_FEATURES"     FEATURE "${APD_FEATURE}" DATA "${output}"     QUIET EXTEND        MARKER "{}" TEXT "${generalfeatureText}")
        createOrAppendField (OBJECT "USER_FEATURES"     FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} QUIET EXTEND        MARKER "{}" TEXT "${generalpackageText}")
        createOrAppendField (OBJECT "USER_FEATURES"     FEATURE "NAMES"          FIELD ${APD_FEATURE} QUIET EXTEND UNIQUE MARKER "{}" TEXT "${generalnameText}")
    endif()
