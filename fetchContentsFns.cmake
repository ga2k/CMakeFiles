...
#        set(APD_PREREQS "-")
    ...
    set(systemfeatureText  "       Feature ${BOLD}${right_padded_feature}${NC} {} for package ${BOLD}${APD_PKGNAME}${NC} and was added to the system feature collection")
    set(libraryfeatureText "       Feature ${BOLD}${right_padded_feature}${NC} {} for package ${BOLD}${APD_PKGNAME}${NC} and was added to the library feature collection")
    set(generalfeatureText "       Feature ${BOLD}${right_padded_feature}${NC} {} for package ${BOLD}${APD_PKGNAME}${NC} and was added to the optional feature collection")
    ...
    elseif(APD_KIND MATCHES "USER")
        ...
        createOrAppendField (OBJECT "USER_FEATURES"     FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} QUIET EXTEND UNIQUE MARKER "{}" TEXT "${generalpackageText}")
