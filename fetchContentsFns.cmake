                ...
                if (MATCHED)
                    if(ns STREQUAL "")
                        if(matching_component)
                            msg( "    -> Feature '${feat_name}' (${pkg_name}::${matching_component}) is already provided by ${targetName} as ${clean_lib}")
                        else ()
                            msg( "    -> Feature '${feat_name}' (${pkg_name}) is already provided by ${targetName} as ${clean_lib}")
                        endif ()
                    else ()
                        if(matching_component)
                            msg( "    -> Feature '${feat_name}' (${ns}::${matching_component}) is already provided by ${targetName} as ${clean_lib}")
                        else ()
                            msg( "    -> Feature '${feat_name}' (${pkg_name}) is already provided by ${targetName} as ${clean_lib}")
                        endif ()
                    endif ()
