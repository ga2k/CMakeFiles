...
set(__longest_feature  "0" CACHE INTERNAL "")
...
#        set(APD_PREREQS "-")
    ...
    if(APD_KIND MATCHES "SYSTEM")
        ...
        createOrAppendField (OBJECT "SYSTEM_FEATURES"   FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} EXTEND        MARKER "{}" TEXT "${systempackageText}")
    ...
    elseif(APD_KIND MATCHES "LIBRARY")
        ...
        createOrAppendField (OBJECT "LIBRARY_FEATURES"  FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} EXTEND        MARKER "{}" TEXT "${librarypackageText}")
    ...
    elseif(APD_KIND MATCHES "USER")
        ...
        createOrAppendField (OBJECT "USER_FEATURES"     FEATURE "PACKAGES"       FIELD ${APD_FEATPKG} EXTEND        MARKER "{}" TEXT "${generalpackageText}")
