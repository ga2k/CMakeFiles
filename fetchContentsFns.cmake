...
#            string(STRIP "${${current_tag}}" ${current_tag})
            ...
            if (current_tag STREQUAL "VERB")
                ...
                if (word1 MATCHES "created")
                    set(VERB "${leading_ws}${BOLD}${YELLOW}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "added")
                    set(VERB "${leading_ws}${BOLD}${WHITE}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "replaced")
                    set(VERB "${leading_ws}${BOLD}${RED}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "extended")
                    set(VERB "${leading_ws}${BOLD}${CYAN}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "skipped")
                    set(VERB "${leading_ws}${BOLD}${BLUE}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                elseif (word1 MATCHES "calling")
                    set(VERB "${leading_ws}${BOLD}${GREEN}${word1}${NC}${inter_ws}${word2}${trailing_ws}")
                endif ()
