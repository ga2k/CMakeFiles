...
#           Keyword         Type        Direction   Description
    ...
    if (A_PP_BIN_DIR AND localBinDir)
        ...
        if (open_bracket GREATER_EQUAL 0 AND close_bracket GREATER ${open_bracket})
            ...
            if (${dirroot} STREQUAL "SRC")
                set(${A_PP_BIN_DIR} ${EXTERNALS_DIR}/${build_folder} PARENT_SCOPE)
                set(build_ok ON)
            elseif (${dirroot} STREQUAL "BUILD")
                set(${A_PP_BIN_DIR} ${BUILD_DIR}/${build_folder} PARENT_SCOPE)
                set(build_ok ON)
            else ()
    ...
    if (A_PP_INC_DIR)
        ...
        if (open_bracket GREATER_EQUAL 0 AND close_bracket GREATER ${open_bracket})
            ...
            if (${dirroot} STREQUAL "SRC")
                ...
                set(inc_ok ON)
            elseif (${dirroot} STREQUAL "BUILD")
                set(${A_PP_INC_DIR} ${BUILD_DIR}/${folder} PARENT_SCOPE)
                set(inc_ok ON)
            else ()
