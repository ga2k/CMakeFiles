...
function(longest)
    set(switches LEFT RIGHT GAP QUIET)
    ...
    if(LONG_JUSTIFY)
        ...
        if(NOT LONG_JUSTIFY STREQUAL "LEFT" AND NOT LONG_JUSTIFY STREQUAL "RIGHT")
            if(NOT LONG_QUIET)
                msg(WARNING "longest(): JUSTIFY must be LEFT or RIGHT, got '${LONG_JUSTIFY}'. Defaulted to LEFT")
            endif ()
            set(LONG_LEFT ON)
            set(LONG_RIGHT OFF)
    ...
    if(LONG_LEFT AND LONG_RIGHT)
        if(NOT LONG_QUIET)
            msg(WARNING "longest(): Can't have both LEFT and RIGHT padding. Pick one. Defaulted to LEFT")
        endif ()
        set(LONG_LEFT ON)
        set(LONG_RIGHT OFF)
        set(LONG_JUSTIFY "LEFT")
    elseif(LONG_LEFT AND LONG_JUSTIFY AND LONG_JUSTIFY STREQUAL "RIGHT")
        if(NOT LONG_QUIET)
            msg(WARNING "longest(): Can't have both LEFT and JUSTIFY RIGHT padding. Pick one. Defaulted to LEFT")
        endif ()
        set(LONG_LEFT ON)
        set(LONG_RIGHT OFF)
        set(LONG_JUSTIFY "LEFT")
    elseif(LONG_RIGHT AND LONG_JUSTIFY AND LONG_JUSTIFY STREQUAL "LEFT")
        if(NOT LONG_QUIET)
            msg(WARNING "longest(): Can't have both RIGHT and JUSTIFY LEFT padding. Pick one. Defaulted to LEFT")
        endif ()
        set(LONG_LEFT ON)
        set(LONG_RIGHT OFF)
        set(LONG_JUSTIFY "LEFT")
