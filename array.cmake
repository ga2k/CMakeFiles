...
macro(record)
    # Capture argument context immediately (macro has no scope; avoid relying on raw ARGC later)
    set(_rec_argc "${ARGC}")
    ...
    elseif(_recVerbUC STREQUAL "REPLACE")
        if(${_rec_argc} LESS 4)
            message(FATAL_ERROR "record(REPLACE): expected record(REPLACE <recVar> <fieldIndex> <newValue>)")
        endif()
