        ...
        if (bytes_read != to_read)
        {
            ...
            if (is_strip)
            {
                TIFFErrorExtR(tif, module,
                              ...
                              tif->tif_row, (long long) already_read, (long long) size);
            }
            else
            {
                TIFFErrorExtR(tif, module,
                              ...
                              (long long) already_read, (long long) size);
            }
            return 0;
        }
    }
    ...
    if (!isMapped(tif))
    {
        ...
        if (cc != size)
        {
            TIFFErrorExtR(tif, module,
                          ...
                          "; got %" TIFF_SSIZE_FORMAT
                          " bytes, expected %" TIFF_SSIZE_FORMAT,
                          tif->tif_row, (long long) cc, (long long) size);
            return ((tmsize_t)(-1));
        }
    }
    else
    {
        ...
        if (n != size)
        {
            TIFFErrorExtR(tif, module,
                          ...
                          "; got %" TIFF_SSIZE_FORMAT
                          " bytes, expected %" TIFF_SSIZE_FORMAT,
                          tif->tif_row, strip, (long long) n, (long long) size);
            return ((tmsize_t)(-1));
        }
    ...
    if (!isMapped(tif))
    {
        ...
        if (cc != size)
        {
            TIFFErrorExtR(tif, module,
                          ...
                          "; got %" TIFF_SSIZE_FORMAT
                          " bytes, expected %" TIFF_SSIZE_FORMAT,
                          tif->tif_row, tif->tif_col, (long long) cc, (long long) size);
            return ((tmsize_t)(-1));
        }
    }
    else
    {
        ...
        if (n != size)
        {
            TIFFErrorExtR(tif, module,
                          ...
                          " bytes, expected %" TIFF_SSIZE_FORMAT,
                          tif->tif_row, tif->tif_col, tile, (long long) n, (long long) size);
            return ((tmsize_t)(-1));
        }
        _TIFFmemcpy(buf, tif->tif_base + ma, size);
    }
