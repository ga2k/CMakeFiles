...
function(fetchContents)
    ...
    dict(SET CUSTOM   NAMES    "${customNames}")
    dict(SET CUSTOM   PACKAGES "${customPackages}")
    dict(SET GLOBAL   NAMES    "${globalNames}")
    dict(SET GLOBAL   PACKAGES "${globalPackages}")
    dict(SET LIBRARY  NAMES    "${libraryNames}")
    dict(SET LIBRARY  PACKAGES "${libraryPackages}")
    dict(SET OPTIONAL NAMES    "${optionalNames}")
    dict(SET OPTIONAL PACKAGES "${optionalPackages}")
    dict(SET PLUGIN   NAMES    "${pluginsystemNames}")
    dict(SET PLUGIN   PACKAGES "${pluginsystemPackages}")
    dict(SET SYSTEM   NAMES    "${systemNames}")
    dict(SET SYSTEM   PACKAGES "${systemPackages}")
#
    set(options HELP)
