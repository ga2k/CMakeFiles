...
#    endforeach ()
    ...
    while (aix LESS numPackages)
        ...
        if (NOT "${_uBits}" STREQUAL "${_sBits}")
            string(REPLACE "${_TOK_LIST_SEP}" ";" _uBits "${_uBits}")
            string(REPLACE "${_TOK_LIST_SEP}" ";" _sBits "${_sBits}")
            ...
            string(JOIN "${_TOK_LIST_SEP}" _bits ${_sBits})
#            string(REPLACE "&&" "${_TOK_LIST_SEP}" _bits "${_bits}")
#            string(REPLACE "&-" "${_TOK_LIST_SEP}" _bits "${_bits}")


            if(NOT _bits)
                set(_bits ${_TOK_EMPTY_FIELD})
            endif ()
