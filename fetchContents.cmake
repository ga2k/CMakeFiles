            ...
            if (this_fetch)
                ...
                if (NOT HANDLED AND NOT ${this_cat} STREQUAL TESTING)
                    ...
                    if (NOT ${this_pkgname} IN_LIST NoLibPackages)
                        ...
                        # Prefer canonical targets for well-known deps when no explicit component targets exist
                        if (NOT anyTargetFound)
                            if ("${this_pkgname}" STREQUAL "magic_enum" AND TARGET magic_enum::magic_enum)
                                addTarget(magic_enum::magic_enum ${this_pkgname} ON "")
                                set(anyTargetFound ON)
                            elseif ("${this_pkgname}" STREQUAL "eventpp" AND TARGET eventpp::eventpp)
                                addTarget(eventpp::eventpp ${this_pkgname} ON "")
                                set(anyTargetFound ON)
                            elseif ("${this_pkgname}" STREQUAL "gtest" AND TARGET GTest::gtest)
                                addTarget(GTest::gtest ${this_pkgname} ON "")
                                set(anyTargetFound ON)
