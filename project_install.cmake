...
function(project_install _Folder)
    ...
    if(APPLE AND APP_TYPE MATCHES "Executable")
        ...
        install(CODE "
            ...
            # 3. Pre-strip all RPATH entries from non-symlink binaries before fixup_bundle runs.
            # fixup_bundle calls install_name_tool -delete_rpath for every rpath found via otool.
            # On incremental installs, rpaths (including @loader_path variants from Homebrew LLVM's
            # libc++) may already be gone — causing a hard error. Stripping all non-system rpaths
            # here first (silently) makes fixup_bundle idempotent across repeated installs.
